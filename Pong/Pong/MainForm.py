...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._timerrigth = System.Windows.Forms.Timer(self._components)
		...
		self._leftscore.ImageAlign = System.Drawing.ContentAlignment.BottomLeft
		self._leftscore.Location = System.Drawing.Point(33, 102)
		...
		self._rightscore.ImageAlign = System.Drawing.ContentAlignment.BottomLeft
		...
		# timerrigth
		# 
		self._timerrigth.Interval = 20
		self._timerrigth.Tick += self.TimerrigthTick
		# 
		# timerleft
		# 
	...
	def MainFormKeyDown(self, sender, e):
		...
		if e.KeyCode == Keys.M:
			reset()
			title.Visible = True
			title.Text = "Use W and S to move left paddle; hit Enter to start"
			tmult.Enabled = True
		...
		if tdum.Enabled:
			if e.KeyCode == Keys.Up:
				self.flagright = False
				tright.Enabled = True
			elif e.KeyCode == Key.Down:
				self.flagright = True
				tright.Enabled = True
			elif tright.Enabled and self.flagright == False:
				tright.Enabled = False
				
		""""TDOD: FINISH MULTIPLAYER CONTROLS"""
	...
	def TimerrigthTick(self, sender, e):
	...
	def MainFormSizeChanged(self, sender, e):
		...
		self._rightscore.Left = self.Wisth - 75 - self._Rightscore.Width
